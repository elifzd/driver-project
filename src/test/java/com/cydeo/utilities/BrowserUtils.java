...
public class BrowserUtils {
    ...
    /**
     *  This method will accept a groups radio buttons as a List if WebElement
     *  It will loop though the List, and click too the radio button with provided attributeValue
     * @param radioButtons
